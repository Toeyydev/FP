    ...
    <div className="wrap jobsheet">
      <div className="js-bar no-print">
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          {ro && <button className="btn" onClick={() => window.open(`/api/jobsheet/joborder?guideId=${encodeURIComponent(guideId)}&date=${date}&slotIdx=${slotIdx}`, "_blank", "noopener")} title="Open your official guide job order (ใบสั่งงานมัคคุเทศก์)">Job order</button>}
