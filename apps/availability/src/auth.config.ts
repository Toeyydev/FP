  ...
  callbacks: {
    ...
    authorized({ auth, request }) {
      ...
      const isPublic =
        ...
        p === "/api/line/webhook" || p === "/api/offers/sweep" || p === "/api/bokun/webhook" || p === "/api/push/health" || p === "/api/email/health" || p === "/api/bokun/health" || p === "/api/google/health" || p === "/api/bookings/debug" ||
